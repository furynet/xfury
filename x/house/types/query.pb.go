...
func init() {
	...
	proto.RegisterType((*QueryDepositsByAccountRequest)(nil), "furynetwork.fury.house.QueryDepositsByAccountRequest")
	proto.RegisterType((*QueryDepositsByAccountResponse)(nil), "furynetwork.fury.house.QueryDepositsByAccountResponse")
	proto.RegisterType((*QueryWithdrawalsByAccountRequest)(nil), "furynetwork.fury.house.QueryWithdrawalsByAccountRequest")
	proto.RegisterType((*QueryWithdrawalsByAccountResponse)(nil), "furynetwork.fury.house.QueryWithdrawalsByAccountResponse")
}
...
func (c *queryClient) DepositsByAccount(ctx context.Context, in *QueryDepositsByAccountRequest, opts ...grpc.CallOption) (*QueryDepositsByAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynetwork.fury.house.Query/DepositsByAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) WithdrawalsByAccount(ctx context.Context, in *QueryWithdrawalsByAccountRequest, opts ...grpc.CallOption) (*QueryWithdrawalsByAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynetwork.fury.house.Query/WithdrawalsByAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_DepositsByAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynetwork.fury.house.Query/DepositsByAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_WithdrawalsByAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynetwork.fury.house.Query/WithdrawalsByAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

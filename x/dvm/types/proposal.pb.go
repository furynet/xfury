...
type PublicKeysChangeProposal struct {
	...
	Result ProposalResult `protobuf:"varint,6,opt,name=result,proto3,enum=furynetwork.fury.dvm.ProposalResult" json:"result,omitempty"`
	...
	Status ProposalStatus `protobuf:"varint,9,opt,name=status,proto3,enum=furynetwork.fury.dvm.ProposalStatus" json:"status,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("furynetwork.fury.dvm.ProposalStatus", ProposalStatus_name, ProposalStatus_value)

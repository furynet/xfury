...
type QueryPublicKeysChangeProposalRequest struct {
	...
	Status ProposalStatus `protobuf:"varint,2,opt,name=status,proto3,enum=furynetwork.fury.dvm.ProposalStatus" json:"status,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*QueryPublicKeysChangeProposalRequest)(nil), "furynetwork.fury.dvm.QueryPublicKeysChangeProposalRequest")
	proto.RegisterType((*QueryPublicKeysChangeProposalResponse)(nil), "furynetwork.fury.dvm.QueryPublicKeysChangeProposalResponse")
	proto.RegisterType((*QueryPublicKeysChangeProposalsRequest)(nil), "furynetwork.fury.dvm.QueryPublicKeysChangeProposalsRequest")
	proto.RegisterType((*QueryPublicKeysChangeProposalsResponse)(nil), "furynetwork.fury.dvm.QueryPublicKeysChangeProposalsResponse")
}
...
func (c *queryClient) PublicKeysChangeProposal(ctx context.Context, in *QueryPublicKeysChangeProposalRequest, opts ...grpc.CallOption) (*QueryPublicKeysChangeProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynetwork.fury.dvm.Query/PublicKeysChangeProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PublicKeysChangeProposals(ctx context.Context, in *QueryPublicKeysChangeProposalsRequest, opts ...grpc.CallOption) (*QueryPublicKeysChangeProposalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynetwork.fury.dvm.Query/PublicKeysChangeProposals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_PublicKeysChangeProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynetwork.fury.dvm.Query/PublicKeysChangeProposal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PublicKeysChangeProposals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynetwork.fury.dvm.Query/PublicKeysChangeProposals",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

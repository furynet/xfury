...
func init() {
	proto.RegisterEnum("furynetwork.fury.market.MarketStatus", MarketStatus_name, MarketStatus_value)
	proto.RegisterType((*Market)(nil), "furynetwork.fury.market.Market")
	proto.RegisterType((*MarketBetConstraints)(nil), "furynetwork.fury.market.MarketBetConstraints")
}

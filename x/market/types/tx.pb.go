...
func init() {
	proto.RegisterType((*MsgAddMarket)(nil), "furynetwork.fury.market.MsgAddMarket")
	proto.RegisterType((*MsgAddMarketResponse)(nil), "furynetwork.fury.market.MsgAddMarketResponse")
	proto.RegisterType((*MsgResolveMarket)(nil), "furynetwork.fury.market.MsgResolveMarket")
	proto.RegisterType((*MsgResolveMarketResponse)(nil), "furynetwork.fury.market.MsgResolveMarketResponse")
	proto.RegisterType((*MsgUpdateMarket)(nil), "furynetwork.fury.market.MsgUpdateMarket")
	proto.RegisterType((*MsgUpdateMarketResponse)(nil), "furynetwork.fury.market.MsgUpdateMarketResponse")
}
...
func (c *msgClient) AddMarket(ctx context.Context, in *MsgAddMarket, opts ...grpc.CallOption) (*MsgAddMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynetwork.fury.market.Msg/AddMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ResolveMarket(ctx context.Context, in *MsgResolveMarket, opts ...grpc.CallOption) (*MsgResolveMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynetwork.fury.market.Msg/ResolveMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateMarket(ctx context.Context, in *MsgUpdateMarket, opts ...grpc.CallOption) (*MsgUpdateMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynetwork.fury.market.Msg/UpdateMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynetwork.fury.market.Msg/AddMarket",
	}
...
func _Msg_ResolveMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynetwork.fury.market.Msg/ResolveMarket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynetwork.fury.market.Msg/UpdateMarket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furynetwork.fury.market.Msg",

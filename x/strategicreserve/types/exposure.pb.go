...
func init() {
	proto.RegisterType((*OrderBookOddsExposure)(nil), "furynetwork.fury.strategicreserve.OrderBookOddsExposure")
	proto.RegisterType((*ParticipationExposure)(nil), "furynetwork.fury.strategicreserve.ParticipationExposure")
}

...
func init() {
	proto.RegisterType((*OrderBookParticipation)(nil), "furynetwork.fury.strategicreserve.OrderBookParticipation")
	proto.RegisterType((*ParticipationBetPair)(nil), "furynetwork.fury.strategicreserve.ParticipationBetPair")
}

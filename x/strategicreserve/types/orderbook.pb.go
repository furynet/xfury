...
func init() {
	proto.RegisterEnum("furynetwork.fury.strategicreserve.OrderBookStatus", OrderBookStatus_name, OrderBookStatus_value)
	proto.RegisterType((*OrderBook)(nil), "furynetwork.fury.strategicreserve.OrderBook")
}
